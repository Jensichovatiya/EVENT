...
export interface EventDropdowns {
  ...
  timezones: StringDropdownOption[];
  venueTypes: StringDropdownOption[];
  venueCategories: StringDropdownOption[];
  // Additional selects added by stored procedure
  employeeCounts?: DropdownOption[];
  industries?: DropdownOption[];
  businessTypes?: DropdownOption[];
  organizerTypes?: DropdownOption[];
  // Ticket-step dropdowns (tables 15-18)
  ticketCategories?: DropdownOption[];
  addonRequired?: DropdownOption[];
  calculationTypes?: DropdownOption[];
  chargeToOptions?: DropdownOption[];
  taxes?: DropdownOption[];
  // Additional dropdowns for arrangement flow
  eventZones?: DropdownOption[];
  arrangementTypes?: StringDropdownOption[];

  // Component dropdown properties
  bookableAs?: DropdownOption[];
  accessibility?: DropdownOption[];
  shapeTypes?: DropdownOption[];
  componentCurrencies?: CurrencyOption[];
  labelPositions?: DropdownOption[];
  componentCategories?: DropdownOption[];

  // Missing ticket/schedule properties
  passIncludes?: DropdownOption[];
  repeatsConfig?: StringDropdownOption[];
}
