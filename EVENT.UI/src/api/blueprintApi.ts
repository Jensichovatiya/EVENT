...
export const blueprintApi = {
  ...
  // Seats
  getSeatsByZone: (zoneId: number, eventId?: number): Promise<ApiResponseModel<ZoneSeat[]>> => {
    const url = eventId ? `/blueprints/seats/zone/${zoneId}?eventId=${eventId}` : `/blueprints/seats/zone/${zoneId}`;
