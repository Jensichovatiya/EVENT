...
import { Box, Typography, Button, IconButton, Chip, Switch, FormControlLabel } from '@mui/material';
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
            ...
            <Box sx={{ flex: 2, display: 'flex', gap: 2, justifyContent: 'flex-start', pl: 2 }}>
              <FormControlLabel
                control={<Switch defaultChecked {...register('showInMenu')} />}
                label="Show in Menu"
              />
              <FormControlLabel
