          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5, mt: 1 }}>
            ...
            <Box sx={{ display: 'flex', gap: 4 }}>
              <AppSwitch
                ...
                onCheckedChange={(val) => currencyForm.setValue('isDefault', val)}
              />
              <AppSwitch
                label="Auto Update Exchange Rate"
                checked={currencyForm.watch('autoUpdateRate')}
                onCheckedChange={(val) => currencyForm.setValue('autoUpdateRate', val)}
              />
            </Box>
