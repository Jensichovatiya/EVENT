...
export const CATALOG: CatalogItem[] = [
  ...
  { type: 'chair', label: 'Chair', category: 'Seating', color: '#B6C2D9', w: 40, h: 40, sizeLabel: '0.8m x 0.8m', Icon: EventSeatIcon },
  ...
  { type: 'sofa', label: 'Sofa', category: 'Furniture', color: '#BFE3C0', w: 80, h: 40, sizeLabel: '2m x 1m', Icon: WeekendIcon },
