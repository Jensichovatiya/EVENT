...
export const WizardStepper: React.FC<StepperProps> = ({ activeStep, completed, onStepClick }) => (
  ...
  >
    {WIZARD_STEPS.map((step, idx) => {
      ...
      const circleBg = isDone ? EP.primary : isActive ? EP.primary : '#fff';
      const circleColor = isDone || isActive ? '#fff' : EP.faint;
      const circleBorder = isDone || isActive ? EP.primary : EP.line;
      return (
