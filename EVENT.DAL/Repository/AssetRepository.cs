...
namespace EVENT.DAL.Repository
{
    public class AssetRepository : IAssetRepository
    {
        ...
        public AssetRepository(IGeneralFunctions gf, IConfiguration config)
        {
            _gf = gf;
            _config = config;
        }

        public async Task<ApiResponseModel<AssetTypeResponse>> AddEditAssetTypeAsync(AssetTypeRequest request)
        {
            try
            {
